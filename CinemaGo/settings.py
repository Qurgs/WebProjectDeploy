...
SECRET_KEY = "django-insecure--qw2kuo4!c&b(2*t33rc2hf(3yqs!exp4(3=5@xa=gnzz*jgsw"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'G2c*Fea234*A62-D*d33BBEfD4e-CCA*',
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'static/cinema/images')
MEDIA_URL = '/images/'
